    ...
    <>
      <div className="slogan-section">
        <div className="sloganText text-center text-light d-flex flex-column align-items-center justify-content-center">
          ...
          <div className="line rounded-pill mx-auto"></div>
          <h1 className="mx-auto my-3 fw-bold fs-1">Work Only For Results</h1>
          ...
          <div className="mt-4">
            <button className="sloganBtn text-uppercase border-0 py-2 px-4 rounded-pill fw-semibold">
              our pricelist
            </button>
          </div>
        </div>
